...
var SelectParent = function (_a) {
    ...
    var _b = React.useState(value), selectvalue = _b[0], setSelectvalue = _b[1];
    var handleChange = function (event) {
        setSelectvalue(event.target.value);
    };
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        " ",
        React__default["default"].createElement("div", { style: { width: "100%", alignItems: "center" } },
            React__default["default"].createElement(FormControl$1, { sx: { m: 1, minWidth: minWidth } },
                React__default["default"].createElement(InputLabel$1, { color: otherProps.color, id: "demo-simple-select-filled-label" },
                    React__default["default"].createElement("div", { style: { color: labelColor, fontSize: labelSize } }, label)),
                React__default["default"].createElement(Select$1, __assign({ variant: "outlined", label: label, placeholder: placeholder, labelId: "demo-simple- select-filled-label", id: "demo-simple-select-filled", value: selectvalue, onChange: handleChange, style: { borderRadius: borderRadius, border: border }, required: isRequired, color: "secondary" }, otherProps), options.map(function (item, index) {
                    return (React__default["default"].createElement(MenuItem$1, { key: index, color: otherProps.color, value: item.name },
                        checkBox ? (React__default["default"].createElement(Checkbox$1, { color: otherProps.color, checked: selectvalue.indexOf(item.name) > -1 })) : null,
                ...
                helperText && !isvalid ? (React__default["default"].createElement(FormHelperText$1, null,
                    React__default["default"].createElement("div", { style: helperTextStyle },
                        helperText,
                        " "))) : null))));
};
