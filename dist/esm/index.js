...
import React__default, { forwardRef, useContext, Children, isValidElement, cloneElement, useState } from 'react';
...
const _excluded$8 = ["aria-describedby", "autoComplete", "autoFocus", "className", "color", "components", "componentsProps", "defaultValue", "disabled", "disableInjectingGlobalStyles", "endAdornment", "error", "fullWidth", "id", "inputComponent", "inputProps", "inputRef", "margin", "maxRows", "minRows", "multiline", "name", "onBlur", "onChange", "onClick", "onFocus", "onKeyDown", "onKeyUp", "placeholder", "readOnly", "renderSuffix", "rows", "size", "slotProps", "slots", "startAdornment", "type", "value"];
...
const _excluded$6 = ["disableUnderline", "components", "componentsProps", "fullWidth", "hiddenLabel", "inputComponent", "multiline", "slotProps", "slots", "type"];
...
var SelectParent = function (_a) {
    var label = _a.label, value = _a.value, minWidth = _a.minWidth, options = _a.options, selectOptionsColor = _a.selectOptionsColor, selectOptionsSize = _a.selectOptionsSize, labelColor = _a.labelColor, labelSize = _a.labelSize, borderRadius = _a.borderRadius, helperTextStyle = _a.helperTextStyle, helperText = _a.helperText, isRequired = _a.isRequired; _a.backgroundColor; var border = _a.border, isvalid = _a.isvalid, placeholder = _a.placeholder, checkBox = _a.checkBox, otherProps = __rest(_a, ["label", "value", "minWidth", "options", "selectOptionsColor", "selectOptionsSize", "labelColor", "labelSize", "borderRadius", "helperTextStyle", "helperText", "isRequired", "backgroundColor", "border", "isvalid", "placeholder", "checkBox"]);
    var _b = useState(value), selectvalue = _b[0], setSelectvalue = _b[1];
    var handleChange = function (event) {
        setSelectvalue(event.target.value);
    };
    return (React__default.createElement(React__default.Fragment, null,
        " ",
        React__default.createElement("div", { style: { width: "100%", alignItems: "center" } },
            React__default.createElement(FormControl$1, { sx: { m: 1, minWidth: minWidth } },
                React__default.createElement(InputLabel$1, { color: otherProps.color, id: "demo-simple-select-filled-label" },
                    React__default.createElement("div", { style: { color: labelColor, fontSize: labelSize } }, label)),
                React__default.createElement(Select$1, __assign({ variant: "outlined", label: label, placeholder: placeholder, labelId: "demo-simple- select-filled-label", id: "demo-simple-select-filled", value: selectvalue, onChange: handleChange, style: { borderRadius: borderRadius, border: border }, required: isRequired, color: "secondary" }, otherProps), options.map(function (item, index) {
                    return (React__default.createElement(MenuItem$1, { key: index, color: otherProps.color, value: item.name },
                        checkBox ? (React__default.createElement(Checkbox$1, { color: otherProps.color, checked: selectvalue.indexOf(item.name) > -1 })) : null,
                ...
                helperText && !isvalid ? (React__default.createElement(FormHelperText$1, null,
                    React__default.createElement("div", { style: helperTextStyle },
                        helperText,
                        " "))) : null))));
};
